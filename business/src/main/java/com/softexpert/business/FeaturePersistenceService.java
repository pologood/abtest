...
public class FeaturePersistenceService {
	...
	public Feature create(Feature entity) throws AppException {
		...
		try {
			...
			throw new AppException(FeatureErroMesage.SAVE_ERROR);
		}
	}
	...
	public Feature edit(Feature entity) throws AppException {
		...
		try {
			...
			throw new AppException(FeatureErroMesage.COULD_NOT_EDIT_ERROR);
		}
	}
	...
	public void delete(Long id) throws AppException {
		try {
			...
			throw new AppException(FeatureErroMesage.DELETE_ERROR);
		}
	}
